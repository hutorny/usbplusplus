...
static_assert(TestUAC2Configuration_1.totallength() == 41, "TestUAC2Configuration_1.totallength()");
...
static_assert(TestUAC2Configuration_3.totallength() == 71, "TestUAC2Configuration_3.totallength()");
